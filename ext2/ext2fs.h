...
/*typedef struct tagEXT2_ACL_HEADER	/* Header of Access Control Lists */
/*{
	DWORD	aclh_size;
...
typedef struct tagEXT2_ACL_ENTRY	/* Access Control List Entry */
/*{
	DWORD	acle_size;
...
/*	WORD	acle_pad1;
	WORD	acle_next;	/* Pointer on next entry for the  same inode or on next free entry */
/*} EXT2_ACL_ENTRY;
