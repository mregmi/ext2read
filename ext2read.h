...
/* structure as input.									*/
#define S_ISDIR(mode)	((mode & 0x0f000) == 0x04000)
#define S_ISLINK(mode)	((mode & 0x0f000) == 0x0a000)
#define S_ISBLK(mode)	((mode & 0x0f000) == 0x06000)
#define S_ISSOCK(mode)	((mode & 0x0f000) == 0x0c000)
#define S_ISREG(mode)	((mode & 0x0f000) == 0x08000)
#define S_ISCHAR(mode)	((mode & 0x0f000) == 0x02000)
#define S_ISFIFO(mode)	((mode & 0x0f000) == 0x01000)
